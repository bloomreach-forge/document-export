...
public interface ExportXmlWorkflow extends Workflow, IWorkflowInvoker {

    /**
     * Exports a document as XML format.
     *
     * @param subjectId the document identifier
     * @param prettyPrint whether to format the XML with indentation
     * @param includeNamespaces whether to include namespace declarations
     * @param includeMetadata whether to include document metadata (creation date, author, etc.)
     ...
     */
    String exportXmlDocument(String subjectId, boolean prettyPrint, boolean includeNamespaces, boolean includeMetadata)
